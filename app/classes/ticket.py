class Ticket:
    def __init__(self, id, requester_name, requester_email, department, raw_description, subject, description, last_ai_gen, ai_attempts, conversations, ticket_created, time_last_message_recieved, time_last_ai_message_post, post_email, post_note, put_fields, closed):
        self.id = id
